...
// WebStudio import/edit/publish endpoints moved OUT of the framework
// worker (#260) — a Nexmatic product surface (site mirroring, npm
// installs, dev-server spawns) doesn't belong in the framework process.
// Code archived at nexaas@cb57762 (packages/runtime/src/webstudio/,
// mcp/servers/webstudio/, worker.ts /api/webstudio/* routes) for
// Nexmatic to absorb — see Systemsaholic/nexmatic issue filed with #260.
