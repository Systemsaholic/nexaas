...
**Nexmatic** is a separate business layer (`/opt/nexmatic/`) that sells AI automation to SMB clients using Nexaas as its execution framework. Ops Console, Client Dashboard, auth, library management. Separate repo, separate license.
