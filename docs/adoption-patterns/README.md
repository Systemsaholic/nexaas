...
| [`external-webhook-callback.md`](./external-webhook-callback.md) | v0.1 — shipped 2026-05-24, Phoenix media-production canary pending (#201) | External SaaS webhook → `POST /api/drawers/inbound` → skill with `triggers: [{type: inbound-message}]` — Stripe / Wise / Sentry / Descript / Forminator / any callback-url pattern |
